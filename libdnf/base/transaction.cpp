...
GoalProblem Transaction::Impl::report_not_found(
    ...
    rpm::PackageQuery query(base, rpm::PackageQuery::Flags::IGNORE_EXCLUDES);
...
void Transaction::Impl::set_transaction(rpm::solv::GoalPrivate & solved_goal, GoalProblem problems) {
    ...
    rpm::PackageQuery installonly_query(base, rpm::PackageQuery::Flags::IGNORE_EXCLUDES);
    ...
    if (!list_removes.empty()) {
        rpm::PackageQuery remaining_installed(base, rpm::PackageQuery::Flags::IGNORE_EXCLUDES);
